...
import ar.edu.unq.eperdemic.spring.controllers.dto.Atributo
...
class Bootstrap (val ubicacionService: UbicacionService, val vectorService: VectorService, val patogenoService: PatogenoService,
    ...
    private fun loadData() {
        ...
        val ubicacionesAUsar = subList.map { nombreDeUbicacion ->  ubicacionService.crear(nombreDeUbicacion, 0.0, 0.0)}
